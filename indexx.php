<?php 
session_start();
$connect = mysqli_connect("https://databases-auth.000webhost.com", "id8919304_speculativevaracto", "admin", "id8919304_dailysales");
	...
	<body>
		...
		<div class="container">
			...
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="indexx.php?action=add&id=<?php echo $row["id"]; ?>">
